...
$allowed = [
    ...
    'verifikasi', 'verifikasi-dokumen', 'tampilan-ttd',
    'sign-document', 'signing-list', 'download-signed',
    'api-sign-doc', 'api-upload-pdf', 'api-debug-otp', 'api-otp-live', 'otp-debug',
    'panduan',
];
...
<nav>
  ...
  <ul class="nav-links">
    ...
    <li><a href="?page=verifikasi-dokumen">🔍 Verifikasi</a></li>
  </ul>
  <div class="nav-right">
